...
public class Main {
	...
	public static void main(String[] args) {
        ...
        LinkedList<String> A1 = new LinkedList<>(Arrays.asList("T1", "T4"));
        LinkedList<String> A2 = new LinkedList<>(Arrays.asList("T2", "T5"));
        LinkedList<String> A3 = new LinkedList<>(Arrays.asList("T3", "T6"));
        LinkedList<String> B1 = new LinkedList<>(Arrays.asList("T7", "T8"));
        LinkedList<String> B2 = new LinkedList<>(Arrays.asList("T9", "T10", "T11", "T12"));
        LinkedList<String> C1 = new LinkedList<>(Arrays.asList("T13", "T15"));
        LinkedList<String> C2 = new LinkedList<>(Arrays.asList("T14", "T17"));
        tInvariantes = new LinkedList<>();
...
/*	for (Nodo nodo : tInvariantes) {
	...
	*/
        ...
        while (!tInvariantes.isEmpty()) {
            ...
            LinkedList<Integer> taux = new LinkedList<>();
        ...
        System.out.println("T-Invariantes Verificadas con exito");
